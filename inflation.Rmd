...
usethis::use_git_config(
  user.name = "Nina Frings", # <-- change to your name
  user.email = "nina.frings@unibas.ch", # <-- and your email
...
inflation %>% 
  ...
  ungroup() %>% 
  ggplot() + theme_minimal() + labs(color=NULL) + scale_color_manual(values=c("darkblue", "darkgreen"))+
